...
class Welance_Kraken_Block_Adminhtml_Images_Skin extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        if ($data = $cache->load('welance_kraken_' . $this->_type . '_images')) {
            ...
            $this->_skinImages = $cacheData['media_images'];
            $this->_skinImageCount = $cacheData['media_image_count'];
            $this->_skinImageFolderCount = $cacheData['media_image_folder_count'];
        }
        ...
        if (empty($this->_skinImages)) {
            ...
            $cacheData = array(
                'media_images' => $this->_skinImages,
                'media_image_count' => $this->_skinImageCount,
                'media_image_folder_count' => $this->_skinImageFolderCount
            );
